...
```
cd existing_repo
git remote add origin https://gitlab.atdcode.ru/erklebleeva/homework-react-21514128.git
git branch -M main
...
запустить контейнер: docker compose -f docker-compose.prod.yml up --build

## Integrate with your tools

- [ ] [Set up project integrations](https://gitlab.atdcode.ru/erklebleeva/homework-react-21514128/-/settings/integrations)
