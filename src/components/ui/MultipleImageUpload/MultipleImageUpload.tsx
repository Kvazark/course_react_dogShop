...
import { AddPhotoIcon, CloseIcon } from '../../../images';
...
export const MultipleImageUpload = ({
	...
	return (
		<div className={s.wrapper}>
			<div
				className={s.wrapper_multipleUpload}
				onDragOver={(event) => event.preventDefault()}
				onDrop={handleDrop}>
				<div className={s.wrapper_multipleUpload_previewList}>
					...
					<div className={s.wrapper_multipleUpload_addPhotoBtn}>
						<SvgIcon
